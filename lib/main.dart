    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          backgroundColor: Color.fromARGB(255, 165, 204, 23),
        ...
        body: Container(
          ...
          decoration: BoxDecoration(
            ...
            Color.fromARGB(255, 160, 165, 165),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        gradient: LinearGradient(colors: [
                          Color.fromARGB(255, 219, 221, 70),
                          Color.fromARGB(255, 159, 161, 161)
                        ])),
                    child: Text('Login',
                        style: TextStyle(
                            color: Color.fromARGB(255, 213, 223, 195)
                                .withOpacity(.8),
                            fontSize: 15,
